        ...
        <Section crosses>
            <div className='container lg:flex'>
                ...
                <div className='lg:ml-auto xl:w-[38rem] mt-4'>
                    ...
                    border border-n-6 md:scale-100'>
                        ...
                        <ul>
                            {collabApps.map((app, index) => (
                                <li 
                                    ...
                                    h-1/2 -ml-[1.6rem] origin-bottom rotate-${
                                        index * 45
                                        }`}
                                >
                                    <div className={`relative w-[3.2rem] h-[3.2rem] border bg-n-7
                                        flex -top-[1.6rem] border-n-1/15 rounded-xl -rotate-${
                                            index*45
                                        }`}>
                                            <img src={app.icon} 
                                            width={app.width}
