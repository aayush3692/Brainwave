        ...
        id="hero"> 
            <div className = 'container relative' ref={parallaxRef}>
                ...
                mb-[4rem] md:mb-20 lg:mb-[6rem]'>
                    ...
                    <p className='body-1 max-w-3xl mx-auto text-n-2 mb-6 lg:mb-8'>Unleash the power of AI within Brainwave. 
                        ...
                        <div className='relative bg-n-8 rounded-[1rem]'>
                            ...
                            md:aspect-[688/490] lg:aspect-[1024/490]'>
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <ul className='hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1
                                    py-1 bg-n-9/10 backdrop-blur border border-n-1/10 rounded-2xl xl:flex'>
                ...
                <CompanyLogo className='hidden relative z-10 mt-10 
                lg:block '/>
            </div>
